...
# Main script for the discovery of Burgers equation with a single dataset 
# =============================================================================
...
# =============================================================================
    layers = [2] + [20]*8 + [1] # 8 hidden layers of 20 nodes
    
    BFGS_epochs_Pre = 1000 # maximum allowable BFGS epochs in pretraining 
    ADO_iterations = 20
    Adam_epochs_ADO = 100
    ...
    model = PiDL(layers, lb, ub, BFGS_epochs_Pre, ADO_iterations, Adam_epochs_ADO, BFGS_epochs_ADO)
